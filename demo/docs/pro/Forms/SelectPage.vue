<template>
  <mdb-container>
    ...
    <section class="demo-section">
      <h4>Select with scrolling disabled</h4>
      <section>
        <mdb-row>
          <mdb-col sm="6">
            <mdb-select
    ...
    <section class="demo-section">
      ...
      <section>
        <mdb-row>
          <mdb-col sm="6">
            <mdb-select search :options="labelOptions" label="Example label" />
          </mdb-col>
        </mdb-row>
      </section>
    </section>
    ...
    <section class="demo-section">
      <h4>Outline select with search</h4>
      <section>
        <mdb-row>
          <mdb-col sm="6">
            <mdb-select
              v-model="outlineOptions"
              palceholder="Choose your option"
              label="Outline select with search"
              outline
              search
            />
          </mdb-col>
