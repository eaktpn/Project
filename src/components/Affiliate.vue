   ...
   <div class="container" v-if="isLogin">
      ...
      <div class="row justify-content-center mt-2">
         <div class="col-xl-9 col-md-9 col-12 font16">
            <section class="preview">
               <mdb-input basic :value="'http://slotimlive22.abatopup.com/systemaff?join=' + codesuggest" disabled>
      ...
      <div class="row justify-content-center mt-2">
         <div class="col-xl-10 col-md-10 col-12">
            <social-sharing :url="'http://slotimlive22.abatopup.com/systemaff?join=' + codesuggest" title="ลิ้งสมัคร " discription="ชวนเพื่อนมาเล่น" quote="ชวนเพื่อนมาเล่นสล๊อต" hashtags="ชวนเพื่อนมาเล่นสลอต" v-cloak inline-template class="row">
...
export default {
   ...
   methods: {
      coppyText() {
         this.$copyText("http://slotimlive22.abatopup.com/systemaff?join=" + this.codesuggest);
