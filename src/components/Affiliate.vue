<template>
	<div class="container" v-if="isLogin">
		...
		<div class="row justify-content-center mt-3" v-if="codejoin !== 'ไม่มีรหัสผู้แนะนำ'">
			<div class="col-xl-9 col-md-9 col-12 mt-1" style="font-weight:400;">
				รหัสผู้แนะนำคุณ : <span style="color:#36d3f5;">{{ codejoin }}</span>
			</div>
		</div>
		...
		<div class="row justify-content-center mt-2" v-if="codesuggestcode !== undefined">
			<div class="col-xl-9 col-md-9 col-12 font16">
				<section class="preview">
					<mdb-input basic :value="'https://sexy222.abatopup.com/systemaff?join=' + codesuggest" disabled>
		...
		<div class="row justify-content-center mt-1" v-if="codesuggestcode !== undefined">
			<div class="col-xl-10 col-md-10 col-12">
				<social-sharing :url="'https://sexy222.abatopup.com/systemaff?join=' + codesuggest" title="ลิ้งสมัคร " discription="ชวนเพื่อนมาเล่น" quote="ชวนเพื่อนมาเล่นสล๊อต" hashtags="ชวนเพื่อนมาเล่นสลอต" v-cloak inline-template class="row">
		...
		<div class="row justify-content-center p-3" v-if="codesuggestcode !== undefined">
			<div class="col-xl-9 col-md-9 col-12 BG-gray">
				<div class="row text-center color_pink">
      ...
      <div class="row justify-content-center p-3" v-if="codesuggestcode !== undefined">
         <div class="col-xl-9 col-md-9 col-12 BG-gray">
            <div class="row text-center color_pink mt-2">
               <span class="col-xl-6 col-md-6 col-6">ว/ด/ป เวลา</span>
...
<script>
	...
	export default {
		...
		methods: {
			coppyText() {
				this.$copyText('https://sexy222.abatopup.com/systemaff?join=' + this.codesuggest)
