         ...
         <div class="col-xl-9 col-md-9 col-12">
            ...
            <div class="row">
               <div class="col-12 color_white font16">
                  ...
                  <span>
                     <date-picker class="input-date" valueType="format" style="margin-left:20px; padding-right:5px;" lang="en" format="YYYY-MM-DD" v-model="dateselect" @change="selectDate()"></date-picker>
                  </span>
               </div>
            </div>
         </div>
