	...
	<div class="BG-Gradient d-flex flex-column justify-content-center">
		<div class="container">
			<div class="row justify-content-center mt-5">
				<div class="col-xl-8 col-md-8 col-11 text-center "><img src="/images/logo/logo.png" width="100%;" style="max-width:330px;" /></div>
			</div>
			<div class="row justify-content-center mt-5">
				<div class="col-xl-5 col-md-7 col-10">
			...
			<mdb-modal class="color_back" :show="showModal" @close="showModal = false" centered>
				...
				<div class="row justify-content-center mb-2">
					<div class="col-xl-11 col-md-11 col-11">
						<mdb-btn block :disabled="check_condition === false" size="sm" :class="check_condition === false ? 'btn-Purple_Pink color_white font16' : 'btn-Purple_Pink color_white font16'" style="font-weight:400;" @click="GoRegister()">ตกลง</mdb-btn>
					</div>
				</div>
			</mdb-modal>
		</div>
