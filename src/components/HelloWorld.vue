<template>
  <div class="hello">
    <h3>{{ msg }}</h3>
    <p class="mb-2">The 1 application is configured and ready to import our components. You will find MDB Vue docs <a href="https://mdbootstrap.com/docs/vue/?utm_source=DemoApp&utm_medium=MDBVue" target="_blank">here</a>.</p>
