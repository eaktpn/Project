	...
	<div class="container" v-if="isLogin">
		<div class="row justify-content-center px-3 mt-4">
			<div class="col-xl-9 col-md-9 col-12 BG-gray-radius" style="font-weight:400;">
				<div class="row justify-content-center">
					<div class="col-6 color_yellow font22">ฝากเงิน</div>
		...
		<div class="row justify-content-center p-3">
			<div class="col-xl-9 col-md-9 col-12 BG-pink color_back font18 p-4" style="font-weight:400;">
				...
				<div class="font14 mt-2" style="color:#606060;">ต้องใช้บัญชีที่สมัครฝากเงินเข้ามาเท่านั้น และต้องโอนเงินผ่านช่องทางแอพพลิเคชั่นของธนาคารบนมือถือเท่านั้น มิเช่นนั้นจะไม่สามารถยืนยันรายการฝากได้<br />ถ้าเกิดข้อผิดพลาดของระบบให้แจ้งกับพนักงานทันที กรณีที่ไม่แจ้งเราขอสงวนสิทธิ์การถอนเงินทุกกรณี</div>
			</div>
		</div>
		<div class="row justify-content-center mt-1">
			<div class="col-xl-9 col-md-9 col-12 text-center">
				...
				<div class="color_gray font14 mt-2">**หลังจากโอนเงินแล้ว ระบบจะใช้เวลาดำเนินการไม่เกิน 1 นาที แต่หากเกินเวลาที่กำหนด ให้ติดต่อพนักงานทันที</div>
			</div>
		</div>
		<div class="mt-3"></div>
	</div>
